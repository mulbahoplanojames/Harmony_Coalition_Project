...
import ebsImage from "/src/assets/Economics-300x157.jpg";
import image1 from "/src/assets/EcoDepartment-550x400.jpg";
import image2 from "/src/assets/Economics-550x4.jpg";
import image3 from "/src/assets/Finance-Dept-550x400.jpg";
import image4 from "/src/assets/Economics-550x400.jpg";
      ...
      <div className=" mt-[4.4rem] pb-10">
        ...
        <div className="container md:mx-auto  md:px-0 md:w-[80%] w-full">
          <div className="md:w-[40%] w-full md:mt-4 mt-0 md:h-[20rem] h-[20rem] bg-red-300 overflow-hidden">
            <img src={ebsImage} alt="Computer Lab" className="w-full h-full" />
          </div>
          <div className="md:px-0 px-2">
            <p className="pt-4 pb-6 opacity-80 text-lg">
              Welcome to the School of Economics and Business Studies
            </p>
...
export default VisitSchoolOfEBS;
