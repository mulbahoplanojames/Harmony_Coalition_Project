            ...
            <div className="w-full px-4">
              ...
              >
                ...
                >
                  ...
                  >
                    <FaLinkedin className="z-40 text-4xl text-primary_main" />
                  </Link>
                  <Link
                  ...
                  >
                    <FaInstagram className="z-40 text-4xl text-primary_main" />
                  </Link>
                  <Link
                  ...
                  >
                    <FaWhatsappSquare className="z-40 text-4xl text-primary_main" />
                  </Link>
                  <Link
                  ...
                  >
                    <FaFacebookSquare className="z-40 text-4xl text-primary_main" />
                  </Link>
                </motion.div>
              </div>
            </div>
