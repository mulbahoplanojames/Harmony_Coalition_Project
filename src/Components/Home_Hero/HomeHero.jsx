          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              ...
              >
                ...
                >
                  <div className="md:text-5xl text-3xl uppercase font-black dark:text-white text-slate-950 md:pr-[8rem] pr-5 sm:pr-2 pb-6 z-50 md:pt-1 pt-8">
                    Welcome <br /> we are here to <br /> {WordFlicker()}
                  </div>
                  <p className="z-40 mb-10 text-lg font-semibold dark:text-white text-slate-950">
                ...
                >
                  ...
                  <p className="pb-3 text-base">
                    EMAIL :
                    {user.studentInfo.email ? user.studentInfo.email : "Email"}
                  </p>
                </motion.div>
                <motion.div
