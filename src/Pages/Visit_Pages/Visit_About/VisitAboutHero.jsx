...
const VisitAboutHero = () => {
  return (
    <>
      {/* <AuroraBackground>
        <div className="grid grid-cols-1 gap-10 px-5 py-16 md:grid-cols-2 place-items-center md:py-24 md:gap-3 md:px-6 lg:px-10 ">
          <motion.div
            animate={{ opacity: 0, x: -60 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.3 }}
            className="pb-4 h-fit"
          >
            <h1 className="pb-6 pr-10 text-3xl font-black uppercase md:text-4xl md:pr-40 dark:text-white text-slate-950">
              Association of liberian Students at kigali independent university
            </h1>
            <p className="pb-10 text-lg font-semibold dark:text-white text-slate-950">
        ...
        <div className="container mx-auto ">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4">
              <div
                className="relative grid w-full grid-cols-1 px-4 py-8 mx-auto rounded-md md:grid-cols-2 place-items-center lg:px-6 md:gap-6 gap-14 h-fit"
                data-wow-delay=".2s"
              >
                <motion.div
                  animate={{ opacity: 0, x: -60 }}
                  ...
                  className="pb-4 h-fit"
                >
                  <h1 className="pb-6 pr-10 text-3xl font-black uppercase md:text-4xl md:pr-30 dark:text-white text-slate-950">
                    Association of liberian Students at kigali independent
                    university
                  </h1>
                  <p className="pb-10 text-lg font-semibold dark:text-white text-slate-950">
                    The leadership of the Association of the Liberian Students
                    at Kigali Independent University welcomes you to the
                    official platform of the Association. We are here to render
